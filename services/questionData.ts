...
export const questions: Question[] = [
  ...
  },
  {
    id: 201,
    topic: "Spark SQL",
    questionText: "Which of the following are characteristics of the Delta Lake protocol? (Select 2)",
    options: [
      { id: "A", text: "ACID Transactions" },
      { id: "B", text: "Direct support for NoSQL databases" },
